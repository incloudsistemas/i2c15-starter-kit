...
use App\Filament\Resources\System\PermissionResource\Pages;
use App\Filament\Resources\System\PermissionResource\RelationManagers;
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\DeleteAction::make()
                        ->before(
                            fn(PermissionService $service, Tables\Actions\DeleteAction $action, Permission $record) =>
                            $service->preventDeleteIf(action: $action, permission: $record)
                        ),
                ])
                    ->label(__('Ações'))
